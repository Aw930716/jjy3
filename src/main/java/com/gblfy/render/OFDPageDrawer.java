...
public class OFDPageDrawer extends PDFGraphicsStreamEngine {
    ...
    private com.gblfy.render.OFDCreator ofdCreator;
    ...
    protected OFDPageDrawer(int idx, PDPage page, com.gblfy.render.OFDCreator ofdCreator, float scale) throws IOException {
        super(page);
        this.page = page;
